...
CREATE OR REPLACE TRIGGER set_updated_at_timestamp_points
BEFORE UPDATE ON points
FOR EACH ROW
EXECUTE PROCEDURE set_updated_at_timestamp();

CREATE OR REPLACE TRIGGER set_updated_at_whatsapp_conv_status
...
CREATE OR REPLACE TRIGGER add_hashid_points
